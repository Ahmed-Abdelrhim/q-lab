...
<body>
<nav class="shelf">
    <a class="book home-page" href="{{route('admin.index')}}" style="text-decoration: none">Home page</a>
    <a class="book about-us" href="{{route('admin.index')}}" style="text-decoration: none">About us</a>
    <a class="book contact" href="{{route('admin.index')}}" style="text-decoration: none">Contact</a>
    <a class="book faq" href="{{route('admin.index')}}" style="text-decoration: none">F.A.Q.</a>
